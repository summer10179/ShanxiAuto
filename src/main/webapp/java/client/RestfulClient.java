...
public class RestfulClient {
    ...
    /** 适用所有post的请求 **/
    /** 发送json请求 */
    public HttpResponse doPostRequest(String url, List<NameValuePair> params, String json, HashMap<String, String> headers) {
//        CloseableHttpClient httpClient = HttpClients.createDefault();
...
//            设置请求主体格式
     ...
     * @param headers
     */
    public HttpResponse PostRequest(String url, String json, HashMap<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        httpPost = new HttpPost(url);
        try {
